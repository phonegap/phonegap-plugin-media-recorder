...
exports.defineAutoTests = function() {
	...
	describe('phonegap-plugin-media-recorder', function () {
		...
		describe('MediaRecorder', function () {
        	...
        	it('should take a MediaStream as constructor arguement', function() {
            	...
            	p.then(function(stream){
            		...
            		expect(media.stream.getVideoTracks()).toBeDefined();
                    expect(media.stream.getAudioTracks()).toBeDefined();
                    ...
                    expect(typeof media.stream.active).toBe('boolean');
